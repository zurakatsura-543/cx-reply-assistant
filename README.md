...
```bash
npm run start --workspace @cx-assistant/api
```
...
WEB_ORIGIN="https://your-vercel-app-url.vercel.app"
...
- Brand-scoped RAG retrieval
- OpenAI-compatible AI generation
- deterministic fallback generator
- guardrails for risky policy windows
- agent edit and approval flow
- customer/agent mode testing
- persisted AI logs
- duplicate KB protection
- polished dashboard UI

Pending:

- replace placeholder live links after deployment
- add architecture diagram
- add written architecture document
- add AI cost/debugging written response
- add leadership/ownership written responses
